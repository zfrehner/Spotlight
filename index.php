                ...
                <div class="card-body">
                    <div class="card-title display-2 img-fluid">
                        ...
                        <div class="text-center">
                            <img src="images/spotlightLogo2.png" alt="logo"><!--image by carousel-->
                        </div>
                    </div>
                </div>
            </div>

            <div id="carouselExampleIndicators" class="carousel slide col-md-6 p-5" data-ride="carousel">
                <!-- start of carousel-->
                ...
                <div class="carousel-inner"> <!-- carousel content-->
                    <div class="carousel-item active">
                        <p><strong>SPOTLIGHT provides you the ability to know
                                ...
                                right gym for your particular workout which best suits your needs for that
                                moment.</strong>
                        </p>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <fieldset class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span class="hidden"
                                                          id="errGender">&#9888; Please choose a gender.</span>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control w-50 mx-auto" id="gym" name="gym">
                                                        ...
                                                        <option value="gym2">LA Fitness - 1347 Auburn Way N · Auburn
                                                            North
                                                        </option>
                                                        <option value="gym3">Peak MMA & Fitness LLC</option>
                                                    </select>
                                                    <span class="hidden"
                                                          id="errGym">&#9888; Please choose an option.</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="note">Workout plan today? (optional)</label>
                                                    <textarea class="form-control w-50 mx-auto" id="note" name="note"
                                                              rows="3"></textarea>
                                                </div>

                                                <button id="btn-subscribe" type="submit" class="btn btn-warning">
                                                    Check-in
                                                </button>
                                            </fieldset>
                                        </div>
